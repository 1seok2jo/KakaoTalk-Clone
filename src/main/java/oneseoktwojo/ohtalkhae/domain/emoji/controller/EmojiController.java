...
public class EmojiController {
    ...
    public ResponseEntity<ApiResponse<EmojiRegisterResponse>> registerEmoji(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, response));//, "이모티콘 등록 성공"
    }
    ...
    public ResponseEntity<ApiResponse<List<EmojiListResponse>>> getAllEmojis() {
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "전체 이모티콘 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<List<EmojiListResponse>>> getPopularEmojis() {
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "인기 이모티콘 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<List<EmojiListResponse>>> getLatestEmojis() {
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "최신 이모티콘 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<List<EmojiListResponse>>> searchEmojis(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "검색 결과 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<List<EmojiListResponse>>> getMyEmojis(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "내 보관함 이모티콘 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<List<EmojiListResponse>>> getBookmarkedEmojis(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "찜한 이모티콘 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<EmojiDetailResponse>> getEmojiDetail(@PathVariable Long emojiId) {
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "이모티콘 상세 조회 성공"
    }
    ...
    public ResponseEntity<ApiResponse<Void>> addBookmark(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, null));//, "이모티콘 찜 등록 성공"
    }
    ...
    public ResponseEntity<ApiResponse<Void>> removeBookmark(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, null));//, "이모티콘 찜 해제 성공"
    }
    ...
    public ResponseEntity<ApiResponse<Void>> buyEmoji(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, null));//, "이모티콘 구매 성공"
    }
    ...
    public ResponseEntity<ApiResponse<EmojiPurchaseCheckResponse>> checkPurchase(
        ...
        return ResponseEntity.ok(ApiResponse.success(200, result));//, "구매 여부 조회 성공"
    }
}
